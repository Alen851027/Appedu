...
public class AE_PerPlatformSettings : MonoBehaviour
{
    ...
    void Legacy_Rendering_Check(Camera cam)
    {
        ...
        {
            var mobileDistortion = cam.GetComponent<AE_LegacyRenderDistortion>();
            if (mobileDistortion == null) mobileDistortion = cam.gameObject.AddComponent<AE_LegacyRenderDistortion>();
