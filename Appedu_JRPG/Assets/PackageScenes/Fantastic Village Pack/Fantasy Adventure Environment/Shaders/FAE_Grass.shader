...
Shader "FAE/Grass"
{
	...
	SubShader
	{
		...
		void vertexDataFunc( inout appdata_full v, out Input o )
		{
			...
			float3 Bending201 = ( v.color.r * -( ( ( normalizeResult184 * appendResult468 ) * ( 1.0 - saturate( ( distance( temp_output_571_0 , ase_worldPos ) / _BendingRadius ) ) ) ) * _BendingInfluence ) );
...
/*ASEBEGIN
Version=17400
1927;29;1906;1004;2847.528;895.499;1;True;False
...
Node;AmplifyShaderEditor.CommentaryNode;202;-2142.645,-2259.974;Inherit;False;2627.3;775.1997;Bending;22;181;183;186;188;184;194;189;191;193;195;196;197;200;198;201;231;232;234;386;468;571;679;Foliage bending away from obstacle;1,1,1,1;0;0
...
ASEEND*/
//CHKSM=30D5DCD0BDC0961DA2265826503D30C07D4345E9